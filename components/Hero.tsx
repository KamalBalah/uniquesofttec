...
const Hero = () => {
  return (
    <div id="home" className="bg-white w-full text-lg">
      <Nav />
      <div className="mt-[35dvh] text-center relative z-2">
        <h1 className="text-5xl font-black text-main text-center mt-10">
          كن <span className="text-secondary">فريداً</span>
        </h1>
        <p className="text-lg mt-3 text-slate">
          في يونيك سوفت، نبتكر حلولًا برمجية مخصصة تساعدك على تطوير أعمالك، من
